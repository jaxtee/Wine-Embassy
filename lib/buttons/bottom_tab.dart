...
import 'package:wine/components/tab_item.dart';
...
class _BottomTabState extends State<BottomTab> with TickerProviderStateMixin{
  ...
  IconData nextIcon = Icons.home_filled;
  IconData activeIcon = Icons.home_filled;
        ...
        child: Row(
          ...
          children: <Widget>[
              ...
              TabItems(
                  ...
                  callbackFunction: () {
                    setState(() {
                      nextIcon = Icons.shopping_cart_rounded;
                      currentSelected = 1;
